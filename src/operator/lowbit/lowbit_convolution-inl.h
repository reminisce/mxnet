 ...
 * \file lowbit_convolution-inl.h
 * \brief
 * \author Ziheng Jiang
*/

#ifndef MXNET_OPERATOR_CONTRIB_lowbit_CONVOLUTION_INL_H_
#define MXNET_OPERATOR_CONTRIB_lowbit_CONVOLUTION_INL_H_
...
struct LowbitConvolutionParam :
  public dmlc::Parameter<LowbitConvolutionParam> {
  TShape kernel;
  TShape stride;
  TShape pad;
  uint32_t num_filter;
  DMLC_DECLARE_PARAMETER(LowbitConvolutionParam) {
...
class LowbitConvolutionProp : public OperatorProperty {
 public:
  ...
  OperatorProperty* Copy() const override {
    auto ptr = new LowbitConvolutionProp();
    ptr->param_ = param_;
    return ptr;
  }

  std::string TypeString() const override {
    return "lowbit_convolution";
  }
...
#endif  // MXNET_OPERATOR_CONTRIB_lowbit_CONVOLUTION_H_
